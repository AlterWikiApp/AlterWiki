...
| 8. *(Should-have)* Zufälliger Artikel | Button, ruft Random-API | 1–2 h |
...
1. Phase 0 starten (Setup).
2. Meilenstein 1 (API-Client) als erste "echte" Coding-Aufgabe an
   Windsurf/Kimi geben, mit `AGENTS.md` + `docs/features/reader.md` als
   Kontext.
3. Nach Phase 0 + Meilenstein 1: kurzer Check, ob die Zeitschätzung noch
   passt, ggf. Roadmap anpassen.
